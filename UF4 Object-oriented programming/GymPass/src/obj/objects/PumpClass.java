...
public class PumpClass extends GymClass implements ClassSchedule {

    public PumpClass(String name, String description, Date date, int duration, int maxCapacity, Banned banned) {
        super(name, description, date, duration, maxCapacity, banned);
    }


    public static void printSchedulePump() {
    ...
    public void printScheduleSpinning() {
        System.out.println("");
    }
